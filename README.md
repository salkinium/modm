...
<ul style="list-style-type:none;">
  <li>✅  Implemented as a software driver in modm.</li>
  <li> ○   Available in hardware but missing a software driver in modm.</li>
  <li> ✗   Unavailable in hardware or device with that peripheral not supported by modm.</li>
</ul>
